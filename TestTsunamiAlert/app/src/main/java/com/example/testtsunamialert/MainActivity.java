package com.example.testtsunamialert;
...
public class MainActivity extends AppCompatActivity {
    ...
    /**
     * URL to query the USGS data set for earthquake information
     */
    ...
    private class TsunamiAsyncTask extends AsyncTask<URL, Void, Event> {
        ...
        private String makeHttpRequest(URL url) throws IOException {
            ...
            try {
                ...
                {
                    Log.e(LOG_TAG,"Error while connecting to server");
                }
            } catch (IOException e) {
                android.widget.Toast.makeText(MainActivity.this, "Cannot be loaded", Toast.LENGTH_SHORT).show();
                Log.e(LOG_TAG,"IO Exception is thrown");
            } finally {
